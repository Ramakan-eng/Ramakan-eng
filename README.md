...
### AI Engineer | GenAI  | Building Intelligent RAG and GenAI Systems with LLMs & Agentic AI
...
[![Location](https://img.shields.io/badge/Location-Gurugram%2C%20India-green)]()
...
**AI Models & APIs:** GPT-4/4o, Claude 3.5, Gemini 1.5 Pro, Llama 3, Mistral, Azure OpenAI  
**LLM Frameworks:** LangChain, LangGraph, CrewAI, n8n (Workflow Automation)  
**Vector Databases:** FAISS, ChromaDB, Pinecone  
**ML/DL:** Scikit-learn, TensorFlow, OpenCV, NLP, CNN, RNN, LSTM
...
**Backend:** FastAPI, Django REST Framework, RESTful APIs, Pydantic, Streamlit  
**Databases:** MySQL, PostgreSQL, FAISS, ChromaDB  
**DevOps & Tools:** Git, GitHub, Docker, MLflow, CI/CD, Postman, Jupyter
...
**Cloud:** Microsoft Azure (AI Services, Azure OpenAI), AWS, OCI - Certified, GCP
